...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640,coordinates=None):
    ...
    def __next__(self):
        ...
        # cv2.rectangle(img0, [375,250], [990,250], [255, 0, 0], int(3),int(2))
        if self.coordinates is not None:
            cv2.rectangle(img0, self.coordinates[0], self.coordinates[1], self.coordinates[2], thickness=3, lineType=cv2.LINE_AA)  # filled
